...
import {addMessageActionCreator, dialogsReducer, updateMessageActionCreator} from "./dialogs_reducer";
import {addAlertActionCreator, sidebarReducer} from "./sidebar_reducer";
//------ BASE TYPE ---------------//
...
export type ActionType = ReturnType<typeof addPostActionCreator>
    ...
    | ReturnType<typeof addAlertActionCreator>
//----- StoreType -------//
